  ...
  return (
    ...
    ">
      ...
      <nav className="flex items-center justify-center">
        ...
        <CustomLink className="ml-4" href="/articles" title="" />
      </nav>
      <nav
      ...
      </div>
    {
      ...
      <nav className="flex items-center justify-center flex-col">
        ...
        <CustomMobileLink toggle={handleClick} className="ml-4 lg:m-0 lg:my-2" href="/articles" title="" />
      </nav>
      <nav
