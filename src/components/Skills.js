...
<>
    ...
    >
        ...
        <Skill name="HTML" x="-20vw" y="2vw" />
          ...
          <Skill name="AI" x="-5vw" y="-10vw" />
          <Skill name="JavaScript" x="20vw" y="6vw" />
          <Skill name="ReactJS" x="0vw" y="12vw" />
          <Skill name="NextJS" x="-20vw" y="-15vw" />
          <Skill name="Google Ads" x="15vw" y="-12vw" />
          <Skill name="Github" x="-35vw" y="-5vw" />
          <Skill name="Web Development" x="32vw" y="-5vw" />
          <Skill name="Cloud" x="0vw" y="-20vw" />
          <Skill name="Coolify" x="-25vw" y="18vw" />
          <Skill name="Tawilwind CSS" x="28vw" y="18vw" />
          <Skill name="AI Automation" x="-24vw" y="10vw" />
